                        ...
                        <form>
                            ...
                            <div className="row">
                                <div className="col-12 col-md-9">
                                    <FormOptions placeholder="Raio-x de Tórax">Digite o nome ou email do usuário</FormOptions>
                                </div>
                            ...
                            <input className="form-control mt-5" type="text" placeholder="Pesquise pelo nome ou email" />
