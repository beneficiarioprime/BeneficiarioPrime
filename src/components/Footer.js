                ...
                <div className="row py-4 link-footer">
                    <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                        ...
                        <ul className="list-unstyled mb-0 text-muted">
                            <li className="mb-2" style={{fontSize: "14px"}}>Av. Paes de barros, 2448 - São Paulo - SP</li>
                            <li className="mb-2"><a className="text-muted" target="_blank" href="https://wa.me/5511967339999">11 96733-9999</a></li>
                    ...
                    <div className="col-lg-3 col-md-6 mb-4 mb-lg-0">
                        ...
                        <ul className="list-unstyled mb-0">
                            ...
                            <li className="mb-2"><a href="https://wa.me/5511967339999" target="_blank" className="text-muted">Contato</a></li>
                        </ul>
                    </div>
